                ...
                {({ open }) => (
                    <>
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="relative flex justify-between lg:gap-8">
                                ...
                                {session ?
                                    <div className="hidden lg:flex lg:items-center lg:justify-end xl:">
                                        <a
                                            href="#"
                                        ...
                                        <Menu as="div" className="flex-shrink-0 relative ml-5">
                                            ...
                                            >
                                                <Menu.Items className="origin-top-right absolute z-10 right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 py-1 focus:outline-none">
                                                        <Menu.Item>
                                                            <div onClick={signOut} className="block py-2 px-4 text-sm text-gray-700 cursor-pointer">
                                                                Sign Out
                                                            </div>
                                                        </Menu.Item>
                    ...
                    >
                      New Project
                                    ...
                                    <a href="login" className="text-center my-auto" >Sign In</a>
                                }
